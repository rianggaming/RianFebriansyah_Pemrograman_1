...
public class user extends javax.swing.JFrame {
    ...
    String sql = "INSERT INTO user "
            + "(username, password, role_user, status_user) "
            + "VALUES (?, ?, ?, ?)";
...
int baris = jTable1.getSelectedRow();
    ...
    if (baris != -1) {
        ...
        idUser = jTable1.getValueAt(baris, 0).toString();
...
try {
    ...
    html += "<h2 align='center'>LAPORAN DATA USER</h2>";
    html += "<table>";
    html += "<tr>"
            + "<th>ID User</th>"
            + "<th>Username/th>"
    ...
    File file = new File("laporan_user.html");
