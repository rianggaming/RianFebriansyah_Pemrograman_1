...
public class parkir extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Area A", "Basement A", "Area B", "Basement B", "Area C", "Basement C" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        || jComboBox2.getSelectedItem().toString().trim().equals("")
    ...
    String sql = "INSERT INTO parkir "
            + "(nama_parkir, kapasitas, status) "
            + "VALUES (?, ?, ?)";
...
try {
    ...
    if (idParkir == null || idParkir.equals("")) {
...
try {
    ...
    if (konfirmasi == JOptionPane.YES_OPTION) {
        ...
        String sql =
                "DELETE FROM `parkir` WHERE id_parkir=?";

        PreparedStatement pst =
                conn.prepareStatement(sql);

        pst.setString(1, idParkir);
...
int baris = jTable1.getSelectedRow();
    ...
    if (baris != -1) {
        ...
        idParkir= jTable1.getValueAt(baris, 0).toString();
...
try {
    ...
    String sql = "SELECT * FROM parkir WHERE "
            + "id_parkir LIKE ? OR "
            + "nama_parkir LIKE ? OR "
            + "kapasitas LIKE ? OR "
            + "status LIKE ?";
...
try {
    ...
    html += "<h2 align='center'>LAPORAN DATA PARKIR</h2>";
    html += "<table>";
    html += "<tr>"
            + "<th>ID Parkir</th>"
            + "<th>Nama Parkir</th>"
    ...
    File file = new File("laporan_parkir.html");
